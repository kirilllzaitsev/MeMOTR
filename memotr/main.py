...
from memotr.utils.utils import distributed_rank, yaml_to_dict
...
def parse_option():
    ...
    parser.add_argument(
        "--available-gpus", type=str, help="Available GPUs, like '0,1,2,3'."
    )
    parser.add_argument(
        "--use-distributed", action="store_true", help="Use distributed training."
    )
    parser.add_argument(
        "--use-checkpoint",
        action="store_true",
    ...
    parser.add_argument(
        "--resume-scheduler", type=str, help="Whether resume the training scheduler."
    )
...
if __name__ == "__main__":
    ...
    # save to yaml
    # import yaml
    # yaml.dump(merged_config, open('./train_mot17.yaml', 'w'), default_flow_style=False)
